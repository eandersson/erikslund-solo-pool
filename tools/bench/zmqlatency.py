...
async def main() -> None:
    ...
    ap.add_argument("--rpc-user", default="erikslund")
    ap.add_argument("--rpc-pass", default="erikslundpass")
    ...
    try:
        await asyncio.wait_for(c.new_job.wait(), 30)  # initial job
    ...
    for _ in range(args.rounds):
        await asyncio.sleep(0.4)        # let any trailing notify settle
        c.new_job.clear()
