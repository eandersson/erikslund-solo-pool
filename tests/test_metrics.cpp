...
TEST_CASE("to_status_json uses the canonical numeric representation") {
    // Golden bytes preserve ".0" for decimal-valued fields, integers for counts, and nulls.
...
TEST_CASE("JSON bodies match the API contract") {
    const auto s = sample();
